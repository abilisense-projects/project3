    ...
    <Provider store={store}>
      <NavigationContainer style={styles.container}>
        <Drawer.Navigator
          ...
          <Drawer.Screen name="ForgotYourPassword" component={ForgotPassword} options={{ headerShown: false }} />
          <Drawer.Screen name="NewPassword" component={NewPassword} options={{ headerShown: false }} />
          <Drawer.Screen name="CodeFromTheEmail" component={CodeFromTheEmail} options={{ headerShown: false }} />
          <Drawer.Screen name="Registration" component={RegistrationScreen} options={{ headerShown: false }} />
          <Drawer.Screen name="Therapist" component={TherapistScreen} options={{ title: "" }} />
          <Drawer.Screen name="Patient" component={PatientScreen} options={{  title: "" }} />
          <Drawer.Screen name="Association" component={AssociatePatient} options={{ title: "" }} />
          {/* all these will appear in the sidebar */}
          {/* <Drawer.Screen name="Home" component={BackgroundSelection} options={{ title: "" }} /> */}
          <Drawer.Screen name="Theme" component={BackgroundSelection} options={{ title: "" }} />
          <Drawer.Screen name="Language" component={BackgroundSelection} options={{ title: "" }} />
          <Drawer.Screen name="Notifications" component={BackgroundSelection} options={{ title: "" }} />
          <Drawer.Screen name="Settings" component={BackgroundSelection} options={{ title: "" }} />
        </Drawer.Navigator>
      </NavigationContainer>
    </Provider>
  );
